 ...
 *     @OA\Property(property="description", type="string", title="Collect point description (max:512)", example="Volunteers uniting to bring aid, donations & transport to Refugees and people in need. Sends convoys to the border regularly"),
